  ...
  render() {
    ...
    return <form data-testid="add-movie-form">
      <fieldset>
        ...
        <textarea name="storyline" id="storyline" cols="30" rows="10" data-testid="storyline-input" value={storyline} onChange={this.changeText}></textarea>
        ...
        <select name="genre" id="genero" onChange={this.changeText} value={genre} data-testid="genre-input">
